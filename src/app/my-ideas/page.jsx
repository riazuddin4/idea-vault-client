...
// import { fetchCourses, fetchIdeasByEmail } from '@/lib/courses/data';
...
//     const ideas =  fetchIdeasByEmail(user?.email || "");

//     useEffect(() => {
//         const getIdeas = async () => {
//             if (user?.email) {
//                 setLoading(true);
//                 const ideas = await fetchIdeasByEmail(user.email);
//                 setMyIdeas(ideas);
//                 setLoading(false);
//             }
//         };
...
//                     {
//                         myIdeas?.map((mongoidea) => <CourseCardIdeas key={mongoidea._id} mongoidea={mongoidea} />)
//                     }
//                 </div>
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <main className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                ...
                {loading ? (
                    <p className="text-center text-gray-500">Loading your ideas...</p>
                ) : myIdeas.length === 0 ? (
